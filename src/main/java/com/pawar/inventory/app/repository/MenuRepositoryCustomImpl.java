...
public class MenuRepositoryCustomImpl implements MenuRepositoryCustom {
	...
	private final static Logger logger = LoggerFactory.getLogger(MenuRepositoryCustomImpl.class.getName());
	...
	public MenuRepositoryCustomImpl(EntityManager entityManager, MenuService menuService, HttpService httpService) {
	...
	public boolean validateLpn(String lpn_name) throws ClientProtocolException, IOException {
		...
		String url = getUrl(AppConstants.MenuEndpoint.VALIDATE_LPN).replace("{lpn_name}", lpn_name);
	...
	public Item getItem(String item_name) throws ClientProtocolException, IOException {
		...
		String url = getUrl(AppConstants.MenuEndpoint.GET_ITEM).replace("{itemName}", item_name);
		String json = httpCall(null, url, HttpMethod.GET, null, null).getBody().toString();
	...
	public Iterable<Category> getfindAllCategories() throws ClientProtocolException, IOException {
		String url = getUrl(AppConstants.MenuEndpoint.GET_ALL_CATEGORIES);
		logger.info("URL : " + url);
	...
	public String categoryAdd(String category_name) throws ClientProtocolException, IOException {
		...
		if (isValidCategory == false) {
			...
			logger.info(json);
			String url = getUrl(AppConstants.MenuEndpoint.ADD_CATEGORY);
			String response = httpCall(null, url, HttpMethod.POST, json, null).getBody().toString();
			return response;
		} else {
	...
	public boolean validateCategory(String category_name) throws ClientProtocolException, IOException {
		...
		String url = getUrl(AppConstants.MenuEndpoint.VALIDATE_CATEGORY).replace("{category_name}", category_name);
		String json = httpCall(null, url, HttpMethod.GET, null, null).getBody().toString();
	...
	public void categoryEdit(String category_name, String updatedCategoryName)
		...
		logger.info("Updated category payload name: {}", updatedCategoryName);
		String url = getUrl(AppConstants.MenuEndpoint.EDIT_CATEGORY).replace("{category_name}", category_name);
		logger.info("URL :" + url);
		JSONObject jsonObject = new JSONObject();

		// Add key-value pairs to the JSONObject
		jsonObject.put("category_name", updatedCategoryName);
	...
	public void categoryDelete(String category_name) throws ClientProtocolException, IOException {
		String url = getUrl(AppConstants.MenuEndpoint.DELETE_CATEGORY).replace("{category_name}", category_name);
	...
	public void deleteCategory(int category_id) throws ClientProtocolException, IOException {
		String url = getUrl(AppConstants.MenuEndpoint.DELETE_CATEGORY_BY_ID).replace("{category_id}", String.valueOf(category_id));
		String json = httpCall(null, url, HttpMethod.DELETE, null, null).getBody().toString();
		logger.info("json : " + json);
	...
	public Iterable<Item> getItems() throws ClientProtocolException, IOException {
		String url = getUrl(AppConstants.MenuEndpoint.GET_ITEMS);
		logger.info("URL : " + url);
	...
	public String itemAdd(String description, String category_name, float length, float width, float height)
		...
		if (isValidItem == false) {
			...
			String url = getUrl(AppConstants.MenuEndpoint.ADD_ITEM);
			String response = httpCall(null, url, HttpMethod.POST, json, null).getBody().toString();
			logger.info("Response : " + response);
			return response;
		} else {
	...
	public boolean validateItemByName(String description) throws ClientProtocolException, IOException {
		...
		String url = getUrl(AppConstants.MenuEndpoint.GET_ITEM_BY_DESC).replace("{itemDesc}", String.valueOf(description));
		logger.info("URL : " + url);
	...
	public boolean validateItem(int item_id) throws ClientProtocolException, IOException {
		...
		String url = getUrl(AppConstants.MenuEndpoint.GET_ITEM_BY_ID).replace("{item_id}", String.valueOf(item_id));
		logger.info("URL : " + url);
	...
	public void deleteItem(int item_id) throws ClientProtocolException, IOException {
		...
		if (isValidItem) {
			String url = getUrl(AppConstants.MenuEndpoint.DELETE_ITEM_BY_ID).replace("{itemId}", String.valueOf(item_id));
			logger.info("url : " + url);
	...
	public ResponseEntity<String> itemEdit(int itemId, String description, String category_name, float length,
		...
		if (isValidItem) {
			...
			item_Json.put("description", newdescription);
			item_Json.put("unit_length", length);
			item_Json.put("unit_width", width);
			item_Json.put("unit_height", height);
			item_Json.put("category", category_Json);
			...
			String json = item.toString();
			logger.info("Item Payload : " + json);
			String url = getUrl(AppConstants.MenuEndpoint.UPDATE_ITEM);
			logger.info("URL : " + url);
	...
	public Iterable<Location> getLocations() throws ClientProtocolException, IOException {
		String url = getUrl(AppConstants.MenuEndpoint.GET_LOCATIONS);
		logger.info("URL : " + url);
	...
	@Override
	public Location getLocationByBarcode(String locn_brcd) throws ClientProtocolException, IOException {
		String url = getUrl(AppConstants.MenuEndpoint.GET_LOCATION_BY_BARCODE).replace("{locn_brcd}", locn_brcd);
		logger.info("URL : " + url);
		String json = httpCall(null, url, HttpMethod.GET, null, null).getBody().toString();
		logger.info("Fetched Location : " + json);
		if (json == null || json.isBlank() || json.contains("\"status\":500") || json.contains("\"status\":404")) {
			return null;
		}
	...
	public String locationAdd(String locn_brcd, String grp, String locn_class, float length, float width, float height,
		...
		if (isValidLocation == false) {
			...
			String url = getUrl(AppConstants.MenuEndpoint.ADD_LOCATION);

			ResponseEntity<String> response = httpCall(null, url, HttpMethod.POST, json, null);
	...
	public boolean validateLocation(String locn_barcode) throws ClientProtocolException, IOException {
		...
		String url = getUrl(AppConstants.MenuEndpoint.GET_LOCATION_BY_BARCODE).replace("{locn_brcd}", locn_barcode);
		logger.info("URL : " + url);
	...
	public ResponseEntity<String> locationEdit(String locn_brcd, String grp, String locn_class, float length,
		...
		if (isValidLocation) {
			...
			logger.info("Location Payload : " + json);
			String url = getUrl(AppConstants.MenuEndpoint.UPDATE_LOCATION_BY_BARCODE).replace("{locn_brcd}", locn_brcd);
	...
	public void deleteLocation(String locn_brcd) throws ClientProtocolException, IOException {
		...
		if (isValidLocation) {
			String url = getUrl(AppConstants.MenuEndpoint.DELETE_LOCATION_BY_BARCODE).replace("{locn_brcd}", locn_brcd);
			String json = httpCall(null, url, HttpMethod.DELETE, null, null).getBody().toString();
			logger.info("json : " + json);
		} else {
	...
	public String lpnEdit(String lpn_name, String item_desc, float length, float width, float height, int quantity,
		...
		logger.info("Lpn Payload : " + json);
		String url = getUrl(AppConstants.MenuEndpoint.UPDATE_LPN).replace("{lpn_name}", lpn_name).replace("{adjustQty}",
	...
	public Iterable<Inventory> getInventories() throws ClientProtocolException, IOException {
		String url = getUrl(AppConstants.MenuEndpoint.GET_INVENTORIES);
		logger.info("URL : " + url);
	...
	@Override
	public Inventory getInventoryByLpnName(String lpn_name) throws ClientProtocolException, IOException {

		String url = getUrl(AppConstants.MenuEndpoint.GET_INVENTORY_BY_LPN).replace("{lpn_name}", lpn_name);
		logger.info("URL : " + url);
	...
	public String locateLpnToResv(String lpn_name, String resv_locn) throws ClientProtocolException, IOException {
		...
		if ((isValidLocation == true && isValidLpn == true)) {
			...
			logger.info("Fetching inventory by LPN before reserve move: {}", lpn_name);
			...
			String url = getUrl(AppConstants.MenuEndpoint.CREATE_RESERVE);
	...
	public String locateLpnToActive(String lpn_name, String active_locn) throws ClientProtocolException, IOException {
		...
		if ((isValidLocation == true && isValidLpn == true)) {
			...
			logger.info("Fetching inventory by LPN before active move: {}", lpn_name);
			JSONObject inventory_json = new JSONObject();
			JSONObject inventory = new JSONObject();
			JSONObject lpn = new JSONObject();
			JSONObject location = new JSONObject();
			...
			String url = getUrl(AppConstants.MenuEndpoint.CREATE_ACTIVE);
	...
	public String checkActiveInventory(String lpn_name) throws ClientProtocolException, IOException {
		...
		String url = getUrl(AppConstants.MenuEndpoint.CHECK_ACTIVE_INVENTORY);
		logger.info("URL : " + url);
		HttpHeaders httpHeaders = new HttpHeaders();
		httpHeaders.setContentType(MediaType.APPLICATION_JSON);
	...
	public Iterable<Grp> getGrps() throws ClientProtocolException, IOException {
		String url = getUrl(AppConstants.MenuEndpoint.GET_GRPS);
		logger.info("URL : {}", url);
		String json = httpCall(null, url, HttpMethod.GET, null, null).getBody().toString();
	...
	public ResponseEntity<String> httpCall(String decodedToken, String url, HttpMethod httpMethod, String json,
		...
		// Delegate to HttpService for centralized HTTP execution
		try {
			...
			logger.error("HTTP call failed to {}: {}", url, e.getMessage());
	...
	public List<SopLocationRangeDto> getLocationRanges() throws ClientProtocolException, IOException {
		String url = getUrl(AppConstants.MenuEndpoint.LOCATION_RANGE);
		logger.info("URL : {}", url);
		String json = httpCall(null, url, HttpMethod.GET, null, null).getBody().toString();
	...
	public List<SopActionTypeDto> getSopActionTypes() throws ClientProtocolException, IOException {
		String url = getUrl(AppConstants.MenuEndpoint.GET_ACTION_TYPES);
		logger.info("URL : {}", url);
		String json = httpCall(null, url, HttpMethod.GET, null, null).getBody().toString();
	...
	public SopActionTypeDto getSopActionType(String actionType) throws ClientProtocolException, IOException {
		String url = getUrl(AppConstants.MenuEndpoint.GET_ACTION_TYPE).replace("{actionType}", actionType);
	...
	public List<Category> getCategories() throws ClientProtocolException, IOException {
		String url = getUrl(AppConstants.MenuEndpoint.GET_CATEGORIES);
		logger.info("URL : {}", url);
		String json = httpCall(null, url, HttpMethod.GET, null, null).getBody().toString();
	...
	public String assignBatch(String actionType, String batchType, String category)
		...
		String url = getUrl(AppConstants.MenuEndpoint.ASSIGN_BATCH);
		logger.info("URL : {}", url);
	...
	public String addLocationRange(String actionType, String category_name, String fromLocation, String toLocation,
		...
		String url = getUrl(AppConstants.MenuEndpoint.LOCATION_RANGE_ADD);
		logger.info("URL : {}", url);
	...
	public String updateLocationRange(String id, String actionType, String category_name, String fromLocation,
		...
		String location_Range_Json = locationRangeJson.toString();
		logger.info("locationRangeJson : {} ", locationRangeJson);
		String url = getUrl(AppConstants.MenuEndpoint.LOCATION_RANGE_UPDATE).replace("{id}", id);
		logger.info("URL : {}", url);
	...
	public List<String> getEligibleUpcsForSop(String category) throws ClientProtocolException, IOException {
		...
		String url = getUrl(AppConstants.MenuEndpoint.GET_ELIGIBLE_UPCS_FOR_SOP_BY_CATEGORY).replace("{category}", category);
		logger.info("url : {} ", url);
		String response = "";
		if (url != null) {
	...
	public Object unassignBatch(String sopActionType, String batchType, String category_name)
		...
		String assign_json = assignJson.toString();
		String url = getUrl(AppConstants.MenuEndpoint.UNASSIGN_BATCH);
		logger.info("URL : {}", url);
		String response = httpCall(null, url, HttpMethod.POST, assign_json, null).getBody().toString();
		return response;
	}
	...
	public List<CubiscanLog> getCubiscanLogs() {
		try {
			...
			String response = "";
			String url = getUrl(AppConstants.MenuEndpoint.GET_CUBISCAN_LOGS);
			if (url != null) {
				response = httpCall(null, url, HttpMethod.GET, null, null).getBody().toString();
